...
select * from trips_data_all.high_vol_partioned limit 1;

select count(*) from trips_data_all.high_vol_tripdata 

-- Question 1:
-- What is count for fhv vehicles data for year 2019
select count(*) from trips_data_all.high_vol_partioned where pickup_datetime between '2019-01-01' and '2019-12-31';

-- Question 2:
-- How many distinct dispatching_base_num we have in fhv for 2019
-- Can run a distinct query on the table from question 1
select count(distinct dispatching_base_num)
from trips_data_all.high_vol_partioned where pickup_datetime between '2019-01-01' and '2019-12-31';
...
create or replace table dtc-de-2022-mg-339910.trips_data_all.high_vol_tripdata_part_clust_2
partition by DATE(dropoff_datetime)
cluster by (dispatching_base_num)
as select * from dtc-de-2022-mg-339910.trips_data_all.high_vol_tripdata;
...
select count(*)
from dtc-de-2022-mg-339910.trips_data_all.high_vol_tripdata_part_clust_2
where  1=1 
and dropoff_datetime between '2019-01-01' and '2019-12-31'
